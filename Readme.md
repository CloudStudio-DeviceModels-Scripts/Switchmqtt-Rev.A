...
# Parsing + Configuration Script – Switch mqtt - Rev. A

This **Parsing + Configuration** script is designed for the **Switch mqtt** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Switch mqtt Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Switch mqtt** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
